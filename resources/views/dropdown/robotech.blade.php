...
<h1 align="center">Robotech Courses</h1>
<div class="content1">
    <img src="{{ asset('images/Roadmap4.jpg') }}" alt="Robotech Course Image">
    <img src="{{ asset('images/Roadmap41.jpg') }}" alt="Robotech Kids Course Image ">
</div>
@include('partials.icons')
<div class="image-container">
        <img src="{{ asset('images/robot-worker.jpg') }}" alt="Image 1">
        <img src="{{ asset('images/robot-kids.jpg') }}" alt="Image 2">
        <img src="{{ asset('images/industrial-machine.jpg') }}" alt="Image 3">
    </div>
