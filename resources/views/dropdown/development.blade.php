...
<div class="content1">
    ...
    <img src="{{ asset('images/Roadmap1.jpg') }}" alt="Development Course Image">
</div>
@include('partials.icons')
<div class="image-container">
        <img src="{{ asset('images/android-app2.webp') }}" alt="Image 1">
        <img src="{{ asset('images/web-development2.jpg') }}" alt="Image 2">
        <img src="{{ asset('images/programming-languages.jpg') }}" alt="Image 3">
    </div>
    </div>
    </div>
