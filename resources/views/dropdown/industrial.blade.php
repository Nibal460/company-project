...
<div class="content1">
    <h1> Industrial Maintenance Courses</h1>
    <img src="{{ asset('images/maintenance32.jpg') }}" alt="IndustrialCourse Image">
</div>
@include('partials.icons')
<div class="image-container">
        <img src="{{ asset('images/maintenance2.webp') }}" alt="Image 1">
        <img src="{{ asset('images/maintenance3.jpg') }}" alt="Image 2">
        <img src="{{ asset('images/maintenance8.jpg') }}" alt="Image 3">
    </div>
    </div>
    </div>
