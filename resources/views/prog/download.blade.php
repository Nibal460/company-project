...
.content {
        ...
        /* CSS for centered image and download link */
/* CSS for centered image and download link */
.center-container {
    display: flex;
...
.center-container img {
    max-width: 35%; /* Ensure image doesn't exceed container width */
    height: auto;
    margin-top:10px;
    margin-bottom: 1px; /* Space between image and link */
}
...
<div class="center-container">
    <p> اضغط على الرابط لتنزيل البرنامج الذي تريده</p>
    <img src="images/download46.png" alt="download image" class="moving-image">
    <a href="https://drive.google.com/drive/folders/1-MEjAHIfSSUmmc2-glWDw9mOrXqeQXtD" target="_blank" download>
        <h2 style="border: 5px solid rgb(57, 190, 239); padding:10px;">Download the programs</h2>
    </a>
</div>
@include('partials.icons')
<div class="image-container">
        <img src="{{ asset('images/industrial-machine.jpg') }}" alt="Image 1">
        <img src="{{ asset('images/programming-languages.jpg') }}" alt="Image 2">
