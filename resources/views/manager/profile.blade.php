...
<body>
    <div class="container">
        ...
        <p style="font-size: 18px;"><strong>First Name:</strong> {{ $manager->first_name }}</p>
        <p style="font-size: 18px;"><strong>Last Name:</strong> {{ $manager->last_name }}</p>
        <p style="font-size: 18px;"><strong>Email:</strong> {{ $manager->email }}</p>
        <p style="font-size: 18px;"><strong>Gender:</strong> {{ $manager->gender }}</p>
