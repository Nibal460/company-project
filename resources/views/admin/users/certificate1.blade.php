...
<body>
    <div class="container" id="certificate">
        ...
        <p><img src="{{ asset('images/TechTurn-certificate.png') }}"></p>
        <h1>CERTIFICATE</h1>
        <p>This is to certify that </P>
        <p><strong>{{ $user->fname }} {{ $user->father_name }} {{ $user->lname }}</strong></p>
        <p>Has successfully completed the course</p>
        <p><strong>{{ $courseProfile3->course_name }}</strong></p>
        <div class="duration"> <strong>{{ $courseProfile3->hours }} hours of practical training from {{ $startDate1 }} to {{ $endDate1 }}</strong></div>
        <div class="awarding">Therefore awarded this certificate on <strong>{{ $awarding1 }}</strong></div>
    </div>
